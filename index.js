const dataSets = {
    items: [
        ...
        'Синдром утёнка // Активное событие',
        'Отключение интернета // Активное событие',
        'Отцы и дети // Активное событие',
        ...
        'Что такое Сега ? // Одноразовое событие,
        'Что такое Плейстейшн ? // Одноразовое событие',
        ...
        'Скип // Предмет',
        'Я не спидранер, я просто быстро прохожу игры // Предмет',
        'Это игровой контент, такое можно // Предмет',
        'Классика жанра // Предмет',
        'Я здесь закон // Предмет',
        'Чат здесь закон // Предмет',
        'DeLorian // Предмет',
        'Slow-Мotion // Предмет',
        'Потрогай траву // Предмет',
        'Антидроп // Предмет',
        'Выкуп // Предмет',
        'WiseTree  // Предмет',
        'Стример Hardкорщик // Предмет',
        'Тяжело... // Предмет',
        'Уолтер, убери свой.. // Предмет',
        'ESTA VIVO?!?! // Предмет',
        'M⊕R✞IS // Предмет',
